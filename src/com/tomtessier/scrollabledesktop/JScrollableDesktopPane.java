...
public class JScrollableDesktopPane extends JPanel 
     ...
     */
     ...
     /** 
       ...
       */
      public void registerMenuBar(JMenuBar mb, boolean tileMode) {
            desktopMediator.registerMenuBar(mb, tileMode);
      }
     ...
     /**
      ...
      public void setAutoTile(boolean tileMode) {
    	  desktopMediator.setAutoTile(tileMode);
      }
      
      public boolean getAutoTile() {
    	  return desktopMediator.getAutoTile();
      }
}
